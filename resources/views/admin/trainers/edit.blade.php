...
<main class="contenido-principal" style="display: flex; justify-content: center; align-items: center; min-height: 100vh; width: 100%; padding: 20px;">
    <div style="width: 100%; max-width: 900px;">
        ...
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h2 style="color: #1a3a6b; font-weight: 700; font-size: 1.8rem;">Editar Entrenador</h2>
            <p style="color: #5a6b7c; font-size: 1rem;">Modifica los datos del entrenador</p>
        </div>
            ...
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.trainers.update', $trainer) }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $trainer->name) }}" required
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="text" name="specialty" id="specialty" class="form-control" value="{{ old('specialty', $trainer->specialty) }}"
                               style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <textarea name="bio" id="bio" rows="4" class="form-control"
                                  style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">{{ old('bio', $trainer->bio) }}</textarea>
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        <label class="form-label" style="color: #1a3a6b; font-weight: 600; font-size: 0.9rem; display: block; text-align: left;">
                            <i class="bi bi-image me-1"></i> Foto actual
                        </label>
                        <div style="margin-top: 0.25rem;">
                            @if($trainer->photo)
                                <img src="{{ asset('storage/' . $trainer->photo) }}" alt="Foto" 
                                     style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 3px solid #1a3a6b;">
                            @else
                                <span class="text-muted" style="color: #6c757d;">Sin foto</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mb-4" style="width: 100%; max-width: 500px;">
                        <label for="photo" class="form-label" style="color: #1a3a6b; font-weight: 600; font-size: 0.9rem; display: block; text-align: left;">
                            <i class="bi bi-upload me-1"></i> Nueva foto (opcional)
                        </label>
                        <input type="file" name="photo" id="photo" class="form-control" accept="image/*"
                               style="border-radius: 8px; border: 2px solid #e9ecef; padding: 10px 14px; font-size: 1rem; width: 100%;">
                        <small class="text-muted" style="display: block; margin-top: 4px;">Formatos: JPG, PNG. Máx 2MB. Dejar vacío para mantener la actual.</small>
