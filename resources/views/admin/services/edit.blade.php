...
<main class="contenido-principal" style="display: flex; justify-content: center; align-items: center; min-height: 100vh; width: 100%; padding: 20px;">
    <div style="width: 100%; max-width: 900px;">
        ...
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h2 style="color: #1a3a6b; font-weight: 700; font-size: 1.8rem;">Editar Servicio</h2>
            <p style="color: #5a6b7c; font-size: 1rem;">Modifica los datos del servicio</p>
        </div>
                ...
                <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data"
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <textarea name="description" id="description" rows="3" class="form-control"
                                  style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">{{ old('description', $service->description) }}</textarea>
                        ...
                        <div style="margin-top: 0.25rem;">
                            @if($service->image)
                                <img src="{{ asset('storage/' . $service->image) }}" alt="Imagen actual" 
                                     style="max-height: 100px; border-radius: 8px; border: 2px solid #e9ecef; padding: 2px;">
                            @else
                                <span class="text-muted" style="color: #6c757d;">Sin imagen</span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <small class="text-muted" style="display: block; margin-top: 4px;">Formatos: JPG, PNG, GIF. Máx 2MB. Dejar vacío para mantener la actual.</small>
