...
<main class="contenido-principal" style="display: flex; justify-content: center; align-items: center; min-height: 100vh; width: 100%; padding: 20px;">
    <div style="width: 100%; max-width: 600px;">
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h2 style="color: #1a3a6b; font-weight: 700; font-size: 1.8rem;">Editar Pregunta Frecuente</h2>
            <p style="color: #5a6b7c; font-size: 1rem;">Modifica los datos de la pregunta</p>
        </div>

        <div class="card shadow-lg border-0" style="border-radius: 16px; overflow: hidden; width: 100%;">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.faqs.update', $faq) }}" style="display: flex; flex-direction: column; align-items: center;">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 400px;">
                        ...
                        <textarea name="answer" id="answer" rows="4" class="form-control" required
                                  style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">{{ old('answer', $faq->answer) }}</textarea>
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 400px;">
                        ...
                        <input type="text" name="keyword" id="keyword" class="form-control" value="{{ old('keyword', $faq->keyword) }}"
                               style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
