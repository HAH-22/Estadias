...
<main class="contenido-principal" style="display: flex; justify-content: center; align-items: center; min-height: 100vh; width: 100%; padding: 20px;">
    <div style="width: 100%; max-width: 900px;">
        ...
        <div style="text-align: center; margin-bottom: 2rem;">
            ...
            <h2 style="color: #1a3a6b; font-weight: 700; font-size: 1.8rem;">Editar carrusel</h2>
            <p style="color: #5a6b7c; font-size: 1rem;">Modifica los datos del carrusel</p>
        </div>

        <div class="card shadow-lg border-0" style="border-radius: 16px; overflow: hidden; width: 100%;">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('admin.slides.update', $slide) }}" enctype="multipart/form-data" style="display: flex; flex-direction: column; align-items: center;">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $slide->title) }}" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="text" name="subtitle" id="subtitle" class="form-control" value="{{ old('subtitle', $slide->subtitle) }}" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <div style="margin-top: 5px;">
                            <img src="{{ asset('storage/' . $slide->image) }}" alt="Slide actual" style="max-height: 100px; border-radius: 8px; border: 2px solid #e9ecef;">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        <label for="image" class="form-label" style="color: #1a3a6b; font-weight: 600; font-size: 0.9rem; display: block; text-align: left;">
                            <i class="bi bi-upload me-1"></i> Nueva imagen (opcional)
                        </label>
                        <input type="file" name="image" id="image" class="form-control" accept="image/*" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 10px 14px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="url" name="link" id="link" class="form-control" value="{{ old('link', $slide->link) }}" placeholder="https://..." style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-3" style="width: 100%; max-width: 500px;">
                        ...
                        <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $slide->order) }}" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 16px; font-size: 1rem; width: 100%;">
                    ...
                    <div class="mb-4" style="width: 100%; max-width: 500px; text-align: left;">
                        <div class="form-check">
                            <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', $slide->is_active) ? 'checked' : '' }}>
